...
ATEC23 is part of MICCAI 2023 online satelite event, which means that participarts are not required to physically attend the conference but still be able to join the challenge.
...
- Testing data release : will be available after the participant submits the [Registration Form](https://drive.google.com/file/d/1u4voqFVtPyhF6OMbmtUHh5JK37Aj_mRJ/view?usp=sharing).
