...
ATEC23 is a MICCAI 2023 online satelite event, which means that participarts are not required to physically attend the conference but still be able to join the challenge.
